...
<div class="background1">   <!-- Added first background image to this division  -->
    ...
    <div class="container1">
      ...
      <button onclick="location.href='getall'">. Visit Now >> .</button>
    </div>
...
-->
  ...
  <div class="background4">
    <div class="container_bg4">
        ...
        <div class="scroll_list">
          <div onclick="location.href='map.jsp'" class="category">
            <img src="img/Capture1.PNG" alt="">
            <h2>Map</h2>
          </div>
          <div onclick="location.href='getall'" class="category">
  ...
  <div class="background5">
    <div class="bg5contents">
      ...
      <button onclick="location.href='ContactUs.jsp'">. Contact us now .</button>
    </div>
  </div>
  ...
  <div class="customer-links">
    ...
    <li><a href = "login.jsp">LogOut</a></li>
     <li><a href="userterm.jsp">Terms &amp; Conditions</a></li>
